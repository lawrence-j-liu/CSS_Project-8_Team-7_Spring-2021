...
Accodring to our DAG, the minimal sufficient adjustment set of covariates for evaluating the relationship between Blood Pressure Medication and Mortality are; *Blood pressure, Education, Income, Simplified Race/Ethnicity, and Sex at birth*. When we control for these three covariates in our model, we are able to ensure that all backdoor paths are blocked and we are able to fulfill the independence assumption. 
